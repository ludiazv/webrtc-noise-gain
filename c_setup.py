...
def PatchedPybind11Extension(name,language,sources,extra_compile_args,define_macros,include_dirs,libraries):
    r = {}
    r['name']= name
    r['language'] = language
    r['sources'] = sources
    r['extra_compile_args']= extra_compile_args
    r['include_dirs']= include_dirs
    r['libraries'] = libraries
    r['cpp_flags'] = cpp_flags
    return r
...
print('\n'.join(ext_modules[0][f'{sys.argv[3]}']))
